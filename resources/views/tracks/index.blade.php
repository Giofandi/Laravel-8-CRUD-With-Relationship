<x-app-layout>
    <x-slot name="header">
        <h2 class="text-center text-xl font-semibold leading-tight text-gray-800">{{ __('Track\'s List') }}</h2>
    </x-slot>
    <div class="py-12">
              ...
              <table class="w-full table-fixed">
                  ...
                  <tbody>
                      ...
                      @foreach($results as $artist)
                          <tr class="bg-gray-100"><td colspan="3" class="w-full text-center text-2xl border px-4 py-2">{{ $artist->name }}</td></tr>
                          @foreach($artist->albums as $album)
                              <tr class="bg-gray-100"><td colspan="3" class="w-full text-center text-xl border px-4 py-2">{{ $album->title }}</td></tr>
                              <tr class="bg-gray-200">
                                  <td class="w-full text-center text-lg border px-4 py-2">Name</td>
                                  <td class="w-full  text-center text-lg border px-4 py-2">Duration</td>
                                  <td class="w-96  text-center text-lg border px-4 py-2">Action</td>
                              </tr>
