<x-app-layout>
    <x-slot name="header">
        <h2 class="text-center text-xl font-semibold leading-tight text-gray-800">{{ __('Album\'s Search') }}</h2>
    </x-slot>
    <div class="py-12">
              ...
              <table class="w-full table-fixed">
                <thead>
                    <tr class="bg-gray-100">
                        <th class="w-full border px-4 py-2">Artist</th>
                        <th class="w-full border px-4 py-2">Album</th>
                  ...
                  <tbody>
                      ...
                      @foreach($results as $album)
                          ...
                          <tr>
                              <td class="w-full border px-4 py-2">{{ $album->artist->name }}</td>
